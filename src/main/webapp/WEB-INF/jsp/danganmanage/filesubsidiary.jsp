					...
					<div class="layui-fluid">
						<div id="tba">
					 		<span style="line-height: 20px;padding-left: 10px;">
					 			...
					 			<a class="font_color">新增数据管理&gt;&gt;</a><a href="${pageContext.request.contextPath}/danganmanage/gofilemanagement" class="font_color">以件管理&gt;&gt;</a><span>管理明细</span>
					 		</span>
					 	</div>
		  ...
		  //时间插件
			...
			layui.use('table', function() {
				...
				table.render({
					...
					url:'${pageContext.request.contextPath}/danganmanage/queryManagerdetailsByFile'+"?timestamp="+Math.random(),
				...
				table.on('tool(description_tabel)', function(obj) {
					...
					if(obj.event === 'destruction') {
						...
						console.log(data)
						$.ajax({
							url:"${pageContext.request.contextPath}/danganmanage/uploadPDF"+"?timestamp="+Math.random(),
							type:"post",
			...
			$().ready(function(){
				...
				$("#fileConditionsBtn").click(function(){
					...
					table.reload('description_tabel', {
						  url:'${pageContext.request.contextPath}/danganmanage/queryManagerdetailsFileByConditions'+"?timestamp="+Math.random(),
