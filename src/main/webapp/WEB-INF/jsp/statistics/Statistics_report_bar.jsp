	...
	<body class="layui-layout-body">
		<div id="LAY_app">
			<div class="layui-layout layui-layout-admin">
				...
				<div class="logo_nav">
					<!-- 头部区域 -->
					<div>
						<span class="logo_img"><img src="${pageContext.request.contextPath}/imgs/home.gif" width="110" height="60"/></span>
					...
					<div class="layui-col-md12">
						<div class="layui-card">
							<div class="layui-card-body">
								<div id="tba">
									<a href="${pageContext.request.contextPath}/report/queryByBox" class="btn-a a">盒统计</a>
									<a href="${pageContext.request.contextPath}/report/queryByFile" class="btn-a">件统计</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="layui-card">
							<div class="layui-card-header" style="text-align: center;">
								<div class="layui-form layui-form-item">
									...
									<span style="font-size: 20px;font-weight: bold;">档案数量统计-盒</span>
		...
		$(document).ready(function() {
			...
			var loadEchar = function(anual){
				$.ajax({
					url : "../report/queryByBox22?l="+Math.random(),
					type : "post",
					async : false,
					cache : false,
					data : {"anual":anual},
						...
						if(jkk==2){
						 form.on('select', function(data){
							...
							table.render({
								...
								width:1000,
								cellMinWidth: 80,
								url: '${pageContext.request.contextPath}/report/queryByBoxTable?anual='+values,
								cols: [
									[ //标题栏
										{
											type: 'numbers',
		...
		$(function(){
			$("#butc").click(function() {
				var anual = $("#year").val();
				window.location.href="${pageContext.request.contextPath}/report/boxExportExcel?anual="+anual;
				/* $.ajax({
					url : "${pageContext.request.contextPath}/report/boxExportExcel",
					type : "post",
					data : "anual="+anual,
					async : false,
					cache : false,
