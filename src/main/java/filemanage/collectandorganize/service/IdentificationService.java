...
public interface IdentificationService {
	 ...
	 * @throws Exception
	 */
	PageBean<FileAttachment> queryImgList(@Param("archiveFileAuthenticateStatus") String archiveFileAuthenticateStatus,
    ...
    PageBean<FileAttachment> findFileByPage(@Param("archiveFileAuthenticateStatus") String archiveFileAuthenticateStatus,
    		@Param("archiveFileAnual") String archiveFileAnual,@Param("quanzongId") String quanzongId,
    		@Param("archiveFileFinishingStatus") String archiveFileFinishingStatus,
    		Integer currentPage) throws Exception;
	 ...
	 * @throws Exception
	 */
    List<FileAttachment> queryAttachmentImgList(
    ...
    List<FileAttachment> queryFileAttachmentById(String archiveFileId) throws Exception;
