 ...
 *
 */
public class ModuleConditionalQueryTool {
	/**
	 * 系统设置	>>	全宗管理
	 */
	...
	public String toString() {
		return "ModuleConditionalQueryTool [quanzongNumber=" + quanzongNumber + ", quanzongName=" + quanzongName
				...
				+ retentionperiodName + ", boxNumber=" + boxNumber + ", boxThickness=" + boxThickness + ", theme="
				+ theme + ", time=" + time + ", content=" + content + ", pcCode=" + pcCode + ", pcName=" + pcName
				+ ", pcTime=" + pcTime + ", ipType=" + ipType + ", subjectHeadings=" + subjectHeadings + "]";
	}
	public ModuleConditionalQueryTool() {
		super();
	}
	public ModuleConditionalQueryTool(String quanzongNumber, String quanzongName, String qrganizationCode,
			...
			String retentionperiodCode, String retentionperiodName, String boxNumber, String boxThickness, String theme,
			String time, String content, String pcCode, String pcName, String pcTime, String ipType,
